...
DMG_NAME="HDDcoin-$LITTLELAMBOCOIN_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/HDDcoin-darwin-arm64/HDDcoin.app HDDcoin-$LITTLELAMBOCOIN_INSTALLER_VERSION-arm64 \
...
# xcrun altool --notarize-app -f HDDcoin-0.1.X.dmg --primary-bundle-id net.littlelambocoin.blockchain -u username -p password
