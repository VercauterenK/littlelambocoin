...
import { AlertDialog, Card, Flex } from '@littlelambocoin/core';
...
function BalanceCard(props: BalanceCardProps) {
  ...
  const balance_ptotal_littlelambocoin = mojo_to_colouredcoin_string(balance_ptotal);
  const balance_pending_littlelambocoin = mojo_to_colouredcoin_string(balance_pending);
  const balance_change_littlelambocoin = mojo_to_colouredcoin_string(balance_change);
  const acc_content =
    balancebox_1 +
    balancebox_2 +
    balancebox_ptotal +
    balancebox_3 +
    balance_ptotal_littlelambocoin +
    balancebox_unit +
    balancebox_hline +
    balancebox_4 +
    balancebox_row +
    ...
    balancebox_pending +
    balancebox_3 +
    balance_pending_littlelambocoin +
    balancebox_unit +
    balancebox_4 +
    balancebox_row +
    balancebox_2 +
    balancebox_change +
    balancebox_3 +
    balance_change_littlelambocoin +
    balancebox_unit +
    balancebox_5;
