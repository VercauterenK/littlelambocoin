...
// import { Flex, FormatLargeNumber } from '@littlelambocoin/core';
...
function prepareGraphPoints(
  ...
  */
  ...
  const points = [
    {
      x: peak.height,
      y: mojo_to_littlelambocoin(start),
      tooltip: mojo_to_littlelambocoin(balance),
    },
  ];
  ...
  data.forEach((item) => {
    ...
    points.push({
      x: timestamp,
      y: mojo_to_littlelambocoin(start),
      tooltip: mojo_to_littlelambocoin(start),
    });
  });
