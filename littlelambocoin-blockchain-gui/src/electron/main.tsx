...
if (!handleSquirrelEvent()) {
  ...
  if (ensureSingleInstance() && ensureCorrectEnvironment()) {
    ...
    const appReady = async () => {
      ...
      // if the daemon isn't local we aren't going to try to start/stop it
      if (littlelambocoinConfig.manageDaemonLifetime()) {
        littlelambocoinEnvironment.startHDDcoinDaemon();
      }
    };
        ...
        submenu: [
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/HDDcoin-Network/littlelambocoin-blockchain/wiki',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/HDDcoin-Network/littlelambocoin-blockchain/wiki/FAQ',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/HDDcoin-Network/littlelambocoin-blockchain/releases',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/HDDcoin-Network/littlelambocoin-blockchain/blob/master/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/HDDcoin-Network/littlelambocoin-blockchain/issues',
              );
            },
          },
          {
