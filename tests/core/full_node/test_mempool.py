...
from littlelambocoin.util.condition_tools import conditions_for_solution
...
from littlelambocoin.full_node.mempool_check_conditions import parse_condition_args
