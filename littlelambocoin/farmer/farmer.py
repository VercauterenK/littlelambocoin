...
from littlelambocoin.pools.pool_config import PoolWalletConfig, load_pool_config
...
from littlelambocoin.util.config import load_config, save_config, config_path_for_filename
...
class Farmer:
    def __init__(
        ...
        if len(self.get_public_keys()) == 0:
            error_str = "No keys exist. Please run 'littlelambocoin keys generate' or open the UI."
