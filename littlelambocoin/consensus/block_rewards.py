...
def calculate_pool_reward(height: uint32) -> uint64:
    ...
    if height == 0:
        ...
        return uint64(int((7 / 8) * 0.25 * _mojo_per_littlelambocoin))
    else:
        return uint64(int((7 / 8) * 0.125 * _mojo_per_littlelambocoin))
...
def calculate_base_farmer_reward(height: uint32) -> uint64:
    ...
    if height == 0:
        ...
        return uint64(int((1 / 8) * 1 * _mojo_per_littlelambocoin))
    elif height < 9 * _blocks_per_year:
        return uint64(int((1 / 8) * 0.5 * _mojo_per_littlelambocoin))
    elif height < 12 * _blocks_per_year:
        return uint64(int((1 / 8) * 0.25 * _mojo_per_littlelambocoin))
    else:
        return uint64(int((1 / 8) * 0.125 * _mojo_per_littlelambocoin))
