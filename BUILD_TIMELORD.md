...
required to run a [Timelord](https://github.com/HDDcoin-Network/littlelambocoin-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/HDDcoin-Network/littlelambocoin-blockchain/blob/main/install-timelord.sh)
