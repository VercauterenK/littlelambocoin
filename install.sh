...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	...
	echo "https://github.com/HDDcoin-Network/littlelambocoin-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
echo ""
echo "Try the Quick Start Guide to running littlelambocoin-blockchain:"
echo "https://github.com/HDDcoin-Network/littlelambocoin-blockchain/wiki/Quick-Start-Guide"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'littlelambocoin init' to begin."
